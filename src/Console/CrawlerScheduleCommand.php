...
namespace ApiiOnline\Crawler\ApiiOnlineCrawler\Console;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\Http;
use ApiiOnline\Crawler\ApiiOnlineCrawler\Crawler;
...
class CrawlerScheduleCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'apii:plugins:apii-crawler:schedule';
    ...
    {
        $this->logger = Log::channel('apii-crawler');
        parent::__construct();
    }
